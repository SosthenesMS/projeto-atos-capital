...
public class DesafioDoLabirintoBk05 {
	...
	public static void main(String[] args) {
		...
		while (!achouSaida && iteracoes < maxIteracoes) {
			...
			boolean moverParaDireita = cAtual < extremidadeColuna && labirinto[lAtual][cAtual + 1].equals(CAMINHO)
					&& right == false;
			boolean moverParaBaixo = lAtual < extremidadeLinha && labirinto[lAtual + 1][cAtual].equals(CAMINHO)
					&& down == false;
