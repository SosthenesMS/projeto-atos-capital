...
public class DesafioDoLabirinto {
	...
	public static void main(String[] args) {
		...
		// resultado.add("C [" + (lAtual--) + ", " + (cAtual + 1) + "]");
		// resultado.add("C [" + (lAtual--) + ", " + (cAtual + 1) + "]");
		...
		// Implementar a lógica de movimentação no labirinto:
		...
		while (!achouSaida && iteracoes < maxIteracoes) {
			...
			// System.out.println(historicoDeMovimentos + "\n");
