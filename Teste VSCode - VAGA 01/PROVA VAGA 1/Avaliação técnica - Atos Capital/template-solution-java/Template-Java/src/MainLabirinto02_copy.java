...
public class MainLabirinto02_copy {
    ...
    public static void main(String[] args) {
        ...
        while (!foundExit) {
            if (startRow > 0 && maze[startRow - 1][startColumn].equals(PATH_CHAR)) {
                ...
                startRow = Integer.parseInt(lastPosition[1]) - 1;
                startColumn = Integer.parseInt(lastPosition[2].substring(0, lastPosition[2].length() - 1)) - 1;
            }
